...
> 5本帯の抵抗では、より精密な抵抗値を示すことができます。この方式では、最初の3つの帯が抵抗値を示し、4つ目が乗数、5つ目が許容誤差です。たとえば、**茶黒黒橙金**の場合、`1(茶)0(黒)0(黒)×10^2(赤)`、許容誤差`±2%(赤)`で、これも`10KΩ`の抵抗を意味しますが、最初の3つの帯により抵抗値をより正確に表現しています。  
> 
